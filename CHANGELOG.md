...
- Extract bits for `APyFixed` and `APyFloat` using "HDL-style", inclusive,
  MSB-first indexing.
- SIMD for single-limb fixed-point complex array multiplication and division.
...
- Updated [nanobind](https://github.com/wjakob/nanobind) from v2.12.0 to v2.13.0.
...
- Updated [nanobind](https://github.com/wjakob/nanobind) from v2.8.0 to v2.12.0.
...
[unreleased]: https://github.com/apytypes/apytypes/compare/v0.5.1...HEAD
[0.5.1]: https://github.com/apytypes/apytypes/releases/tag/v0.5.1
[0.5.0]: https://github.com/apytypes/apytypes/releases/tag/v0.5.0
