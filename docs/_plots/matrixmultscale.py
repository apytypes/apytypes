...
benchmarks = {
    ...
    "APyTypes e5m2": ("c = a @ b", CREATE_TWO_FLOAT_E5M2_MATRICES),
    "APyTypes bloat16": ("c = a @ b", CREATE_TWO_FLOAT_BFLOAT16_MATRICES),
    "APyTypes half": ("c = a @ b", CREATE_TWO_FLOAT_HALF_MATRICES),
    "APyTypes single": ("c = a @ b", CREATE_TWO_FLOAT_SINGLE_MATRICES),
    "APyTypes double": ("c = a @ b", CREATE_TWO_FLOAT_DOUBLE_MATRICES),
