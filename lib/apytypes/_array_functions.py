...
def squeeze(a: APyArray, axis: int | tuple[int, ...] | None = None) -> APyArray:
    ...
    Parameters
    ----------
    a : :class:`APyFloatArray`, :class:`APyFixedArray`, or :class:`APyCFixedArray`, or
...
@overload
def convolve(
    a: APyCFixedArray, v: APyFixedArray, mode: Literal["full", "same", "valid"] = "full"
) -> APyCFixedArray: ...
@overload
def convolve(
    a: APyCFloatArray, v: APyFloatArray, mode: Literal["full", "same", "valid"] = "full"
) -> APyCFloatArray: ...
