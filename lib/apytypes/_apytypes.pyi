...
class APyCFixed:
    ...
    def __getstate__(self) -> tuple[int, int, list[int]]: ...
    def __setstate__(self, arg: tuple[int, int, Sequence[int]], /) -> None: ...
    @overload
...
class APyCFixedArray:
    ...
    def __getstate__(self) -> tuple[int, int, list[int], list[int]]: ...
    def __setstate__(
        self, arg: tuple[int, int, Sequence[int], Sequence[int]], /
    ) -> None: ...
    @overload
    ...
    @overload
    def __add__(self, arg: APyFixed) -> APyCFixedArray: ...
    @overload
    def __add__(self, arg: APyFixedArray) -> APyCFixedArray: ...
    @overload
    ...
    @overload
    def __sub__(self, arg: APyFixed) -> APyCFixedArray: ...
    @overload
    def __sub__(self, arg: APyFixedArray) -> APyCFixedArray: ...
    @overload
    ...
    @overload
    def __mul__(self, arg: APyFixed) -> APyCFixedArray: ...
    @overload
    def __mul__(self, arg: APyFixedArray) -> APyCFixedArray: ...
    @overload
    ...
    @overload
    def __truediv__(self, arg: APyFixed) -> APyCFixedArray: ...
    @overload
    def __truediv__(self, arg: APyFixedArray) -> APyCFixedArray: ...
    @overload
    ...
    @overload
    def __eq__(self, arg: APyCFixedArray, /) -> NDArray[numpy.bool]: ...
    @overload
    def __eq__(self, arg: APyCFixed, /) -> NDArray[numpy.bool]: ...
    @overload
    def __eq__(self, arg: APyFixed, /) -> NDArray[numpy.bool]: ...
    @overload
    def __eq__(self, arg: APyFixedArray, /) -> NDArray[numpy.bool]: ...
    @overload
    def __eq__(self, arg: complex, /) -> NDArray[numpy.bool]: ...
    @overload
    def __eq__(self, arg: float, /) -> NDArray[numpy.bool]: ...
    @overload
    def __eq__(self, arg: int, /) -> NDArray[numpy.bool]: ...
    @overload
    def __ne__(self, arg: APyCFixedArray, /) -> NDArray[numpy.bool]: ...
    @overload
    def __ne__(self, arg: APyCFixed, /) -> NDArray[numpy.bool]: ...
    @overload
    def __ne__(self, arg: APyFixed, /) -> NDArray[numpy.bool]: ...
    @overload
    def __ne__(self, arg: APyFixedArray, /) -> NDArray[numpy.bool]: ...
    @overload
    def __ne__(self, arg: complex, /) -> NDArray[numpy.bool]: ...
    @overload
    ...
    @overload
    def __radd__(self, arg: APyFixed) -> APyCFixedArray: ...
    @overload
    def __radd__(self, arg: APyFixedArray) -> APyCFixedArray: ...
    @overload
    ...
    @overload
    def __rsub__(self, arg: APyFixed) -> APyCFixedArray: ...
    @overload
    def __rsub__(self, arg: APyFixedArray) -> APyCFixedArray: ...
    @overload
    ...
    @overload
    def __rmul__(self, arg: APyFixed) -> APyCFixedArray: ...
    @overload
    def __rmul__(self, arg: APyFixedArray) -> APyCFixedArray: ...
    @overload
    ...
    @overload
    def __rtruediv__(self, arg: APyFixed) -> APyCFixedArray: ...
    @overload
    def __rtruediv__(self, arg: APyFixedArray) -> APyCFixedArray: ...
    @overload
    ...
    @overload
    def convolve(
        self, other: APyCFixedArray, mode: ConvolutionMode = ConvolutionMode.FULL
    ) -> APyCFixedArray:
        """
    ...
    @overload
    def convolve(
        self, other: APyCFixedArray, mode: Literal["full", "same", "valid"] = "full"
    ) -> APyCFixedArray: ...
    ...
    def __matmul__(
        self, rhs: APyCFixedArray | APyFixedArray
    ) -> APyCFixedArray | APyCFixed: ...
    def __repr__(self) -> str: ...
    def __str__(self, base: int = 10) -> str: ...
    def __getitem__(
    ...
    def __iter__(self) -> APyCFixedArrayIterator: ...
    def __array__(
        self, dtype: object | None = None, copy: bool | None = None
    ) -> NDArray[numpy.complex128]: ...

class APyCFixedArrayIterator:
    def __iter__(self) -> APyCFixedArrayIterator: ...
    def __next__(self) -> APyCFixedArray | APyCFixed: ...
...
class APyCFloat:
    ...
    def __getstate__(
        self,
    ) -> tuple[tuple[int, int, int], list[tuple[bool, int, int]]]: ...
    def __setstate__(
        self, arg: tuple[tuple[int, int, int], Sequence[tuple[bool, int, int]]], /
    ) -> None: ...
    @overload
    ...
    def __and__(self, arg: APyCFloat, /) -> APyCFloat: ...
    def __or__(self, arg: APyCFloat, /) -> APyCFloat: ...
    def __xor__(self, arg: APyCFloat, /) -> APyCFloat: ...
    def __invert__(self) -> APyCFloat: ...
    @property
...
class APyCFloatArray:
    ...
    def __getstate__(
        self,
    ) -> tuple[tuple[int, int, int], list[int], list[tuple[bool, int, int]]]: ...
    def __setstate__(
        self,
        arg: tuple[
            tuple[int, int, int], Sequence[int], Sequence[tuple[bool, int, int]]
        ],
        /,
    ) -> None: ...
    @overload
    ...
    @overload
    def __add__(self, arg: APyFloat) -> APyCFloatArray: ...
    @overload
    def __add__(self, arg: APyFloatArray) -> APyCFloatArray: ...
    @overload
    ...
    @overload
    def __sub__(self, arg: APyFloat) -> APyCFloatArray: ...
    @overload
    def __sub__(self, arg: APyFloatArray) -> APyCFloatArray: ...
    @overload
    ...
    @overload
    def __mul__(self, arg: APyFloat) -> APyCFloatArray: ...
    @overload
    def __mul__(self, arg: APyFloatArray) -> APyCFloatArray: ...
    @overload
    ...
    @overload
    def __truediv__(self, arg: APyFloat) -> APyCFloatArray: ...
    @overload
    def __truediv__(self, arg: APyFloatArray) -> APyCFloatArray: ...
    @overload
    ...
    @overload
    def __eq__(self, arg: APyCFloatArray, /) -> NDArray[numpy.bool]: ...
    @overload
    def __eq__(self, arg: APyCFloat, /) -> NDArray[numpy.bool]: ...
    @overload
    def __eq__(self, arg: APyFloat, /) -> NDArray[numpy.bool]: ...
    @overload
    def __eq__(self, arg: APyFloatArray, /) -> NDArray[numpy.bool]: ...
    @overload
    def __eq__(self, arg: int, /) -> NDArray[numpy.bool]: ...
    @overload
    def __eq__(self, arg: float, /) -> NDArray[numpy.bool]: ...
    ...
    def __eq__(self, arg: complex, /) -> NDArray[numpy.bool]: ...
    @overload
    def __ne__(self, arg: APyCFloatArray, /) -> NDArray[numpy.bool]: ...
    @overload
    def __ne__(self, arg: APyCFloat, /) -> NDArray[numpy.bool]: ...
    @overload
    def __ne__(self, arg: APyFloat, /) -> NDArray[numpy.bool]: ...
    @overload
    def __ne__(self, arg: APyFloatArray, /) -> NDArray[numpy.bool]: ...
    @overload
    def __ne__(self, arg: int, /) -> NDArray[numpy.bool]: ...
    @overload
    def __ne__(self, arg: float, /) -> NDArray[numpy.bool]: ...
    ...
    @overload
    def __radd__(self, arg: APyFloat) -> APyCFloatArray: ...
    @overload
    def __radd__(self, arg: APyFloatArray) -> APyCFloatArray: ...
    @overload
    ...
    @overload
    def __rsub__(self, arg: APyFloat) -> APyCFloatArray: ...
    @overload
    def __rsub__(self, arg: APyFloatArray) -> APyCFloatArray: ...
    @overload
    ...
    @overload
    def __rmul__(self, arg: APyFloat) -> APyCFloatArray: ...
    @overload
    def __rmul__(self, arg: APyFloatArray) -> APyCFloatArray: ...
    @overload
    ...
    @overload
    def __rtruediv__(self, arg: APyFloat) -> APyCFloatArray: ...
    @overload
    def __rtruediv__(self, arg: APyFloatArray) -> APyCFloatArray: ...
    @overload
    ...
    @overload
    def convolve(
        self, other: APyCFloatArray, mode: ConvolutionMode = ConvolutionMode.FULL
    ) -> APyCFloatArray:
        """
        Return the discrete linear convolution with another one-dimensional array.
    ...
    @overload
    def convolve(
        self, other: APyCFloatArray, mode: Literal["full", "same", "valid"] = "full"
    ) -> APyCFloatArray: ...
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> APyCFloatArrayIterator: ...
    def __array__(
        self, dtype: object | None = None, copy: bool | None = None
    ) -> NDArray[numpy.complex128]: ...

class APyCFloatArrayIterator:
    def __iter__(self) -> APyCFloatArrayIterator: ...
    def __next__(self) -> APyCFloatArray | APyCFloat: ...
...
class APyFixedArray:
    ...
    def __radd__(self, arg: complex) -> APyCFixedArray: ...
    @overload
    def __radd__(self, arg: APyCFixedArray) -> APyCFixedArray: ...
    @overload
    ...
    def __rsub__(self, arg: complex) -> APyCFixedArray: ...
    @overload
    def __rsub__(self, arg: APyCFixedArray) -> APyCFixedArray: ...
    @overload
    ...
    def __rmul__(self, arg: complex) -> APyCFixedArray: ...
    @overload
    def __rmul__(self, arg: APyCFixedArray) -> APyCFixedArray: ...
    @overload
    ...
    def __rtruediv__(self, arg: complex) -> APyCFixedArray: ...
    @overload
    def __rtruediv__(self, arg: APyCFixedArray) -> APyCFixedArray: ...
    @overload
    ...
    @overload
    def convolve(
        self, other: APyFixedArray, mode: ConvolutionMode = ConvolutionMode.FULL
    ) -> APyFixedArray:
        """
        Return the discrete linear convolution with another one-dimensional array.
    ...
    @overload
    def convolve(
        self, other: APyFixedArray, mode: Literal["full", "same", "valid"] = "full"
    ) -> APyFixedArray: ...
...
class APyFloat:
    ...
    def __getstate__(self) -> tuple[tuple[int, int, int], tuple[bool, int, int]]: ...
    def __setstate__(
        self, arg: tuple[tuple[int, int, int], tuple[bool, int, int]], /
    ) -> None: ...
    @overload
    def __eq__(self, arg: APyFloat, /) -> bool: ...
    @overload
...
class APyFloatArray:
    ...
    def __ne__(self, arg: APyFloat, /) -> NDArray[numpy.bool]: ...
    @overload
    def __lt__(self, arg: APyFloatArray, /) -> NDArray[numpy.bool]: ...
    @overload
    def __lt__(self, arg: int, /) -> NDArray[numpy.bool]: ...
    @overload
    def __lt__(self, arg: float, /) -> NDArray[numpy.bool]: ...
    @overload
    def __lt__(self, arg: APyFloat, /) -> NDArray[numpy.bool]: ...
    @overload
    def __gt__(self, arg: APyFloatArray, /) -> NDArray[numpy.bool]: ...
    @overload
    def __gt__(self, arg: int, /) -> NDArray[numpy.bool]: ...
    @overload
    def __gt__(self, arg: float, /) -> NDArray[numpy.bool]: ...
    @overload
    def __gt__(self, arg: APyFloat, /) -> NDArray[numpy.bool]: ...
    @overload
    def __le__(self, arg: APyFloatArray, /) -> NDArray[numpy.bool]: ...
    @overload
    def __le__(self, arg: int, /) -> NDArray[numpy.bool]: ...
    @overload
    def __le__(self, arg: float, /) -> NDArray[numpy.bool]: ...
    @overload
    def __le__(self, arg: APyFloat, /) -> NDArray[numpy.bool]: ...
    @overload
    def __ge__(self, arg: APyFloatArray, /) -> NDArray[numpy.bool]: ...
    @overload
    def __ge__(self, arg: int, /) -> NDArray[numpy.bool]: ...
    @overload
    def __ge__(self, arg: float, /) -> NDArray[numpy.bool]: ...
    ...
    @overload
    def convolve(
        self, other: APyFloatArray, mode: ConvolutionMode = ConvolutionMode.FULL
    ) -> APyFloatArray:
        """
        Return the discrete linear convolution with another one-dimensional array.
    ...
    @overload
    def convolve(
        self, other: APyFloatArray, mode: Literal["full", "same", "valid"] = "full"
    ) -> APyFloatArray: ...
