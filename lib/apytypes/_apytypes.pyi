...
class APyCFixedArray:
    ...
    def reshape(self, number_sequence: int | tuple[int, ...]) -> APyCFixedArray:
        """
...
class APyFixedArray:
    ...
    def reshape(self, number_sequence: int | tuple[int, ...]) -> APyFixedArray:
        """
...
class APyFloatArray:
    ...
    def reshape(self, number_sequence: int | tuple[int, ...]) -> APyFloatArray:
        """
