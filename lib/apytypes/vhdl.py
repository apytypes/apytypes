...
def generate_rom(
    ...
    frac_bits : int, optional
        If *fixed_pkg* is True and *address* is not provided, use this many fractional bits for address.
    fixed_pkg : bool, default: False
        Use ``ieee.fixed_pkg`` for the resulting ROM.
...
def _write_rom(
    ...
    if synchronous or not fixed_pkg:
        f.write("use ieee.std_logic_1164.all;\n")
    if anyfixed:
        f.write("use ieee.fixed_pkg.all;\n")
    if anyfloat:
        f.write("use ieee.float.all;\n")
    ...
    f.write("begin\n")
    f.write("  with address select data_tmp <=\n")
