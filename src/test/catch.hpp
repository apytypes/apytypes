...
// Only do this if we're not using clang on Windows, which uses `diagnostic push` &
// `diagnostic pop`
...
#define CATCH_REGISTER_TAG_ALIAS(alias, spec)                                          \
    ...
    namespace {                                                                        \
        Catch::RegistrarForTagAliases                                                  \
            INTERNAL_CATCH_UNIQUE_NAME(AutoRegisterTagAlias)(                          \
...
#define INTERNAL_CATCH_NTTP_1(signature, ...)                                          \
    ...
    struct rewrap<NttpTemplateTypeList<Container>, List<__VA_ARGS__>, Elements...> {   \
        using type = typename append<                                                  \
            ...
            typename rewrap<NttpTemplateTypeList<Container>, Elements...>::type>::     \
            type;                                                                      \
    };                                                                                 \
    template <                                                                         \
        template <typename...>                                                         \
    ...
    struct create<Final, NttpTemplateTypeList<Containers...>, TypeList<Types...>> {    \
        using type = typename append<                                                  \
            Final<>,                                                                   \
            typename rewrap<NttpTemplateTypeList<Containers>, Types...>::type...>::    \
            type;                                                                      \
    };
...
#define INTERNAL_CATCH_NTTP_REGISTER_METHOD0(TestName, signature, ...)                 \
    template <typename Type>                                                           \
    void reg_test(                                                                     \
        TypeList<Type>, Catch::StringRef className, Catch::NameAndTags nameAndTags     \
    )                                                                                  \
    {                                                                                  \
        Catch::AutoReg(                                                                \
...
#define INTERNAL_CATCH_NTTP_REGISTER_METHOD(TestName, signature, ...)                  \
    template <INTERNAL_CATCH_REMOVE_PARENS(signature)>                                 \
    void reg_test(                                                                     \
        Nttp<__VA_ARGS__>, Catch::StringRef className, Catch::NameAndTags nameAndTags  \
    )                                                                                  \
    {                                                                                  \
        Catch::AutoReg(                                                                \
...
#define INTERNAL_CATCH_NTTP_GEN(...)                                                                                                                                                                                                                                                                            \
    INTERNAL_CATCH_EXPAND_VARGS(                                                                                                                                                                                                                                                                                \
        INTERNAL_CATCH_VA_NARGS_IMPL(__VA_ARGS__, INTERNAL_CATCH_NTTP_1, INTERNAL_CATCH_NTTP_1, INTERNAL_CATCH_NTTP_1, INTERNAL_CATCH_NTTP_1, INTERNAL_CATCH_NTTP_1, INTERNAL_CATCH_NTTP_1, INTERNAL_CATCH_NTTP_1, INTERNAL_CATCH_NTTP_1, INTERNAL_CATCH_NTTP_1, INTERNAL_CATCH_NTTP_1, INTERNAL_CATCH_NTTP_0)( \
            __VA_ARGS__                                                                                                                                                                                                                                                                                         \
        )                                                                                                                                                                                                                                                                                                       \
    )
#define INTERNAL_CATCH_DEFINE_SIG_TEST_METHOD(TestName, ...)                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
...
#define INTERNAL_CATCH_NTTP_REG_METHOD_GEN(TestName, ...)                                                                                                                                                                                                                                                                                                                                                                                                                                                    \
    INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_VA_NARGS_IMPL("dummy", __VA_ARGS__, INTERNAL_CATCH_NTTP_REGISTER_METHOD, INTERNAL_CATCH_NTTP_REGISTER_METHOD, INTERNAL_CATCH_NTTP_REGISTER_METHOD, INTERNAL_CATCH_NTTP_REGISTER_METHOD, INTERNAL_CATCH_NTTP_REGISTER_METHOD, INTERNAL_CATCH_NTTP_REGISTER_METHOD, INTERNAL_CATCH_NTTP_REGISTER_METHOD, INTERNAL_CATCH_NTTP_REGISTER_METHOD, INTERNAL_CATCH_NTTP_REGISTER_METHOD, INTERNAL_CATCH_NTTP_REGISTER_METHOD0, INTERNAL_CATCH_NTTP_REGISTER_METHOD0)( \
        TestName, __VA_ARGS__                                                                                                                                                                                                                                                                                                                                                                                                                                                                                \
    ))
#define INTERNAL_CATCH_NTTP_REG_GEN(TestFunc, ...)                                                                                                                                                                                                                                                                                                                                                      \
    INTERNAL_CATCH_EXPAND_VARGS(                                                                                                                                                                                                                                                                                                                                                                        \
...
struct NameAndTags {
    NameAndTags(
        StringRef const& name_ = StringRef(), StringRef const& tags_ = StringRef()
    ) noexcept;
    StringRef name;
    StringRef tags;
};
...
struct IMutableEnumValuesRegistry {
    ...
    registerEnum(StringRef enumName, StringRef allEnums, std::vector<int> const& values)
        = 0;
...
template <typename T, typename = void> struct StringMaker {
    ...
    static typename std::
        enable_if<::Catch::Detail::IsStreamInsertable<Fake>::value, std::string>::type
...
namespace detail {
    ...
    struct is_range_impl<
        T,
        typename void_type<decltype(begin(std::declval<T>()))>::type> : std::true_type {
    };
} // namespace detail
...
) // Converting int to T* using reinterpret_cast (issue on x64 platform)
...
#define INTERNAL_CATCH_CAPTURE(varName, macroName, ...)                                \
    auto varName = Catch::Capturer(                                                    \
        macroName, CATCH_INTERNAL_LINEINFO, Catch::ResultWas::Info, #__VA_ARGS__       \
    );                                                                                 \
...
struct IRegistryHub {
    ...
    virtual IExceptionTranslatorRegistry const& getExceptionTranslatorRegistry() const
        = 0;
...
struct IMutableRegistryHub {
    ...
    virtual void registerTagAlias(
        std::string const& alias, std::string const& tag, SourceLineInfo const& lineInfo
    ) = 0;
...
#define INTERNAL_CATCH_THROWS_MATCHES(                                                 \
    ...
    do {                                                                               \
        Catch::AssertionHandler catchAssertionHandler(                                 \
            ...
            CATCH_INTERNAL_LINEINFO,                                                   \
            CATCH_INTERNAL_STRINGIFY(__VA_ARGS__                                       \
            ) ", " CATCH_INTERNAL_STRINGIFY(exceptionType                              \
            ) ", " CATCH_INTERNAL_STRINGIFY(matcher),                                  \
            resultDisposition                                                          \
        );                                                                             \
        if (catchAssertionHandler.allowThrows())                                       \
...
namespace Generators {
    ...
    public:
        ...
        {
            assert(
                m_target_repeats > 0 && "Repeat generator must repeat at least once"
            );
        }
...
namespace Detail {
    ...
    inline std::string getAnnotation(
        Class cls, std::string const& annotationName, std::string const& testCaseName
    )
    {
...
public:
    ...
    Matches matchesByFilter(
        std::vector<TestCase> const& testCases, IConfig const& config
    ) const;
...
struct IReporterRegistry {
    ...
    create(std::string const& name, IConfigPtr const& config) const
        = 0;
...
public:
    ...
    XmlWriter&
    endElement(XmlFormatting fmt = XmlFormatting::Newline | XmlFormatting::Indent);
    ...
    namespace Detail {
        ...
        public:
            ...
            template <
                typename Fun,
                typename std::
                    enable_if<!is_related<Fun, BenchmarkFunction>::value, int>::type
                = 0>
    ...
    namespace Detail {
        ...
        )
        {
            ...
            std::tie(sum_squares, sum_cubes) = std::accumulate(
                ...
                jack.end(),
                std::make_pair(0., 0.),
                [jack_mean](std::pair<double, double> sqcb, double x)
...
namespace Benchmark {
    namespace Detail {
        ...
        {
            return run_for_at_least<
                       Clock>(std::chrono::duration_cast<ClockDuration<Clock>>(warmup_time), warmup_seed, &resolution<Clock>)
                .iterations;
        }
        template <typename Clock>
        ...
        estimate_clock_resolution(int iterations)
        {
            auto r
                = run_for_at_least<
                      Clock>(std::chrono::duration_cast<ClockDuration<Clock>>(clock_resolution_estimation_time), iterations, &resolution<Clock>)
                      .result;
            return {
...
namespace Benchmark {
    struct Benchmark {
        ...
        template <
            typename Fun,
            typename std::enable_if<!Detail::is_related<Fun, Benchmark>::value, int>::
                type
            = 0>
...
namespace Benchmark {
    namespace Detail {
        template <typename T, bool Destruct> struct ObjectStorage {
            using TStorage = typename std::
                aligned_storage<sizeof(T), std::alignment_of<T>::value>::type;
    ...
    namespace Detail {
        ...
        )
        {
            ...
            auto n = static_cast<int>(
                last - first
            ); // seriously, one can't use integral types without hell in C++
...
namespace Detail {
    ...
    bool Approx::equalityComparisonImpl(const double other) const
    {
        ...
        // Approx's value Thanks to Richard Harris for his help refining the scaled
        // margin value
...
public:
    ...
    {
        assert(
            m_started && "Handler cannot be uninstalled without being installed first"
        );
        m_started = false;
        disengage_platform();
    }
...
clara::Parser makeCommandLineParser(ConfigData& config)
{
    ...
    auto cli
        ...
        | Opt(config.benchmarkWarmupTime,
              ...
              "amount of time in milliseconds spent on warming up each test (default: "
              "100)"
        )
...
bool isDebuggerActive()
{
    // We need to find another way to determine this for non-appleclang compilers on
    // macOS
    return false;
}
#endif
...
namespace Detail {
    ...
    class EnumValuesRegistry : public IMutableEnumValuesRegistry {
        ...
        EnumInfo const& registerEnum(
            StringRef enumName, StringRef allEnums, std::vector<int> const& values
        ) override;
    };
...
{
    assert(
        !altStackMem && "Cannot initialize POSIX signal handler when one already exists"
    );
    if (altStackSize == 0) {
...
public:
    ...
    std::vector<TestCase> const& getAllTestsSorted(IConfig const& config
    ) const override;
...
public:
    ...
    void
    add(std::string const& alias, std::string const& tag, SourceLineInfo const& lineInfo
    );
...
auto RunContext::acquireGeneratorTracker(
...
std::vector<TestCase> const& TestRegistry::getAllTestsSorted(IConfig const& config
) const
{
...
namespace {
    ...
    public:
        ...
        AssertionPrinter(
            std::ostream& _stream, AssertionStats const& _stats, bool _printInfoMessages
        )
            : stream(_stream)
...
void ConsoleReporter::printSummaryRow(
    std::string const& label, std::vector<SummaryColumn> const& cols, std::size_t row
)
{
    for (auto col : cols) {
...
#define CHECKED_ELSE(...)                                                              \
    INTERNAL_CATCH_ELSE(                                                               \
        "CHECKED_ELSE", Catch::ResultDisposition::ContinueOnFailure, __VA_ARGS__       \
    )
#define CHECK_NOFAIL(...)                                                              \
    INTERNAL_CATCH_TEST(                                                               \
        "CHECK_NOFAIL",                                                                \
...
#define CHECK_THROWS(...)                                                              \
    INTERNAL_CATCH_THROWS(                                                             \
        "CHECK_THROWS", Catch::ResultDisposition::ContinueOnFailure, __VA_ARGS__       \
    )
...
#define CHECK_THAT(arg, matcher)                                                       \
    INTERNAL_CHECK_THAT(                                                               \
        "CHECK_THAT", matcher, Catch::ResultDisposition::ContinueOnFailure, arg        \
    )
