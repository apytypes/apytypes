...
public:
    ...
    {
        return n_mac >= thread_pool_settings.apyfixedarray.n_mac_threshold;
    }
...
public:
    ...
    APyCFixedArray rsubc(const APyCFixed& rhs) const;
    APyFixedArray rdiv(const APyFixed& rhs) const;
    APyCFixedArray rdivc(const APyCFixed& rhs) const;
